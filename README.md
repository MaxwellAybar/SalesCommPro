...
SalesCommPro/ ├── SalesCommPro.Web <-- Interfaz de Usuario (ASP.NET Core MVC) ├── SalesCommPro.Application <-- Objetos de Transferencia de Datos (DTOs) ├── SalesCommPro.Domain <-- Entidades y Reglas del Negocio └── SalesCommPro.Infrastructure <-- Lógica de Cálculo y Servicios
...
El sistema mostrará la comisión calculada automáticamente
...
Autor
Maxwell Aybar 2024 2150 Proyecto académico — Programación II
